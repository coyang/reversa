...
> Strategy for validating behavioral equivalence between the legacy and the new system, adapted to the paradigm chosen in `paradigm_decision.md`.
...
- **Immutability**: <critical points to watch>
...
- **Origin**: `_reversa_sdd/characterization_specs/` or equivalent if available.
