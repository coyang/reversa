...
- **Applied on**: <column or table>
- **Rule**: <explicit text>
- **Handling of invalids**: <discard | reject | fill with default>
- **Origin of the rule**: <reference to `target_business_rules.md` or `discard_log.md`>
...
> See also `cutover_plan.md`. Only the data-specific part here.
