...
> Items that require human decision before the coding agent can start.
...
> List here items whose default was applied without human confirmation. Recommended to review before cutover.

- <or: pipeline executed in interactive mode, no auto-decided items>

## Final notes
<Orchestrator's observations for the coding agent.>
