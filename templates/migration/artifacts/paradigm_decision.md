...
> Conscious decision about how to handle the change (or absence) of paradigm between the legacy and the target stack.
> This artifact is required first reading for any subsequent agent and for the coding agent.
