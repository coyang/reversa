<!--
  ...
  Consumed data: _reversa_sdd/architecture.md (parsed)

  Markers:
  - TOPOLOGY_LEGACY: left column, detected topology of the legacy
  - TOPOLOGY_MODERN: right column, proposed modern alternative
  - TOPOLOGY_HYBRID: optional, central strip with the hybrid option
-->
