<!--
  ...
  Consumed data: assets/data/modules.json, assets/data/deps.json

  Markers:
  - D3_CANVAS: SVG of the force-directed graph
...
<section class="reversa-doc-graph-stage" data-mode="force-directed">
    <svg id="d3-canvas" class="reversa-doc-d3-canvas" aria-label="Modules map">
        <!-- D3_CANVAS -->
    </svg>
</section>
...
<details class="reversa-doc-graph-legend">
    ...
    <ul>
        ...
        <li>Edge: dependency. Thickness proportional to the weight.</li>
