...
<!--
Up to five lines. Say what the feature delivers, for whom, and which legacy problem it solves.
...
<!-- Who uses it, with which goal, at what frequency. -->
...
Before the first Q&A session, keep the section with the notice below.
-->

> No Q&A session recorded yet. Run `/reversa-clarify` when there is a pending `[DOUBT]`.
