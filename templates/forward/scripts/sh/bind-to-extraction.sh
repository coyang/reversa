...
# Helper that reads _reversa_sdd/ and returns a JSON with the canonical sources that the forward skills must consult as context.
# REVERSA differentiator: forward skills never start from scratch; they always bind their reasoning to the reverse-pipeline artifacts.
#
# Usage:
