...
- **Fit for derived appetite** (`<conservative | balanced | transformational>`): <text>
- **Trade-offs**:
  - Pros: <list>
  - Cons: <list>
...
| Compatibility with paradigm shift | | | |
...
- <e.g.: large paradigm shift + transformational appetite → consider Parallel Run for validation>

## Human decision
- **Chosen strategy**: <A | B | C>
- **Who decided**: <name>
- **When**: <ISO-8601>
- **Decision-maker's justification**: <free text>
