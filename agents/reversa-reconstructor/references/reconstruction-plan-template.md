...
**Ready when:** All tables from the ERD exist with correct types, constraints, and foreign keys
...
**Builds:** state flow implementation for each entity
...
**Ready when:** All acceptance criteria from the user stories are satisfied
