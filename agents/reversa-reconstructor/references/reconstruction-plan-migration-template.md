...
**Ready when:** All tables/collections from the target data model exist with correct types, constraints, and relations
...
**Ready when:** Migration scripts tested on representative volume, validations match the plan
...
**Alert:** [if there is a REFERRED TO CODING item associated]
...
**Ready when:** New system receives traffic per the plan and legacy can be shut down/frozen as decided
...
**Ready when:** All critical flows defined in parity_specs.md pass on both systems with equivalent results
