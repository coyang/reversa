...
Quick verification checklist that the Designer applies before closing `target_architecture.md` and `target_domain_model.md`.
...
- [ ] Pure functions in the core; side effects at the boundary.
...
- [ ] No shared mutation.
- [ ] Independent and individually testable stages.
