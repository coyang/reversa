...
Use this scale in **every** statement in the specs. No exceptions.
...
- The rule is in a descriptive comment alongside the relevant code
...
Action: rephrase the statement as an inference, not certainty.
