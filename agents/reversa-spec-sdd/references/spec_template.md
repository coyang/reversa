...
> Remove italicized instructions when finished.
...
> *Describe UI/UX behavior, not visuals. Wireframes can be referenced.*
...
- Success state: [what to show after completing]
...
> *This section is where specs tend to fail. Think about the difficult cases.*
...
> *Unresolved doubts that may impact the design. Each item must have an owner and deadline.*
