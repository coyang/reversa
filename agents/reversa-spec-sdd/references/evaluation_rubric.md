...
| Acceptance criteria defined for each Must RF | 7 | "Acceptance Criterion" column filled in |
...
| Criterion | Points | How to verify |
|-----------|--------|---------------|
| Absence of vague terms without definition | 8 | "quickly", "soon", "many", "some" without a value — -2 each |
...
**Penalties:**
- Vague non-goals ("future functionality"): -2 per occurrence
...
**Penalties:**
- Zero edge cases: -10 (this section zeros out)
...
- [ ] Any dev can implement without asking anything?
- [ ] Any QA can write tests without asking anything?
...
- [ ] Are success metrics numeric and verifiable?
