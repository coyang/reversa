...
**Table version:** 2.0
**Reference date of the benchmarks:** 2026-05

Documents the static references that the `reversa-pricing-estimate` agent uses for the Market Range scenario. v2 removes total ranges invented by combination and uses hourly benchmark by country and seniority, deriving the total via the hour range from `effort-formula.md`.

## Mandatory disclaimer

The numbers are educational approximations based on public and commercial sources known as of May 2026. They do not replace updated regional research. Many public sources provide monthly or annual salary, not a direct freelance rate. When the row derives a freelance rate from salary, the `source_kind` field must say this explicitly.
...
- Computrabajo Mexico, salaries of Developer and Desarrollador IT, updated in 2025: https://mx.computrabajo.com/salarios/desarrollador-it
...
2. If using salary, register `source_kind = salary_derived_freelance_estimate`
