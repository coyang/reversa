...
Extensible catalog used by the `reversa-pricing-profile` agent to map the tax regime declared by the user into an approximate `tax_factor`. The factors are educational reserves for budgeting, not exact legal rates.
...
The factors registered here are educational approximations based on public references known as of 2026-05. They do not replace accounting guidance. Accuracy depends on deductibles, municipality, revenue bracket, CNAE, classification, withholdings, international treaties, and rules in force at the time the invoice is issued.
...
| autonomo_pf | Self-employed individual, carne-leao | 0.275 | effective_reserve_estimate | false | false | Receita Federal, progressive IRPF and INSS | Reserve for senior professional. Effective rate varies by deductions and social security contribution. |
...
- Spain, Agencia Tributaria, regimes for determining income: https://sede.agenciatributaria.gob.es/Sede/irpf/empresarios-individuales-profesionales/regimenes-determinar-rendimiento-actividad.html
...
3. Mark whether the factor includes VAT, IVA or separately listed tax
