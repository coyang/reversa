...
> Consumed by the six agents in the Migration Team. Does not ask about paradigm (Paradigm Advisor's responsibility) or appetite (derived in `paradigm_decision.md`).
