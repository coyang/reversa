...
export async function runInstallPrompts(detectedEngines) {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      loop: false,
      choices: [
        { name: 'Off — pause after every file (safest, default)',         value: 'off'  },
        { name: 'Unit — pause only between units / modules (recommended)', value: 'unit' },
        { name: 'Full — run the whole plan without pausing (fastest)',    value: 'full' },
      ],
      default: 'off',
    },
  ]);
